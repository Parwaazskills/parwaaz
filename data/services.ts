import {
  FileText, HardHat, Monitor,
  Lightbulb, BookOpen,
  Users, Award, Briefcase, ClipboardList, BarChart3, LineChart,
  PieChart, Target, CheckCircle2, TrendingUp, MessageSquare, Smile, Globe,
 Database, GraduationCap, Mail,
} from "lucide-react";
...
export type ServiceItem = {
  ...
  title: string;
  body: string;
icon: LucideIcon | typeof OfficeChair | typeof PayrollIcon | typeof ServiceIcon;
  btn: string;
};

export const servicesData: Record<string, ServiceItem[]> = {
  Training: [
    { eyebrow: "Office Accommodation", title: "Services", body: "End-to-end workspace and accommodation solutions to support your team's productivity. From office setup to housing, we handle all logistics for a seamless experience.", icon: OfficeChair, btn: "Learn More" },
    { eyebrow: "Design & Construction", title: "Management", body: "Delivering comprehensive project support from concept to completion. Our services include architecture, BIM modeling, and construction management to ensure your projects are executed with precision.", icon: HardHat, btn: "Learn More" },
    { eyebrow: "Customized Technology", title: "Solutions", body: "Providing bespoke technology solutions designed to meet your unique business needs. Our team of experts specializes in developing custom programs and systems that not only drive innovation but also ensure sustainable growth and success for your business.", icon: Monitor, btn: "Learn More" },
    ...
    { eyebrow: "International Recruitment", title: "& Payroll", body: "Connecting top Pakistani talent with global opportunities. We provide comprehensive recruitment and manpower solutions to meet the needs of international partners.", icon: PayrollIcon, btn: "Learn More" },
{ eyebrow: "Payroll, Contract & Visa Management", title: "Services", body: "Empowering Pakistan's workforce with world-class skills through global partnerships like Coursera. Unlock new career opportunities with tailored programs designed for modern professionals.", icon: ServiceIcon, btn: "Learn More" },
  ],
  "HR services": [
