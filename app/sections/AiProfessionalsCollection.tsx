...
export default function AiProfessionalsCollection() {
  return (
    <section className="w-full bg-white px-[16px] py-[34px]">
      <div className="mx-auto w-full max-w-[1254px] rounded-t-[33px] bg-gradient-to-r from-[#000572] to-[#33368E] px-[42px] pb-[36px] pt-[66px] max-[1024px]:px-[28px] max-[768px]:px-[20px] max-[480px]:px-[14px]">
        ...
        <div className="mt-[60px] grid grid-cols-4 gap-[13px] max-[1024px]:grid-cols-2 max-[768px]:mt-[42px] max-[640px]:grid-cols-1">
          {courses.map((course, index) => (
            <div
              key={index}
              className="overflow-hidden rounded-t-[13px] bg-white shadow-[0_0_0_1px_rgba(255,255,255,0.06)]"
            >
